...
/**
 * @method peerCount
 * @desc request peer count of ABOS
 * @param null
...
/**
 * @method getMetaData
 * @desc request metadata of ABOS, including `chainId`, `chainName`, `operator`, `website`, `genesisTimestamp`, `validators`, `blockInterval`, `tokenName`, `tokenSymbol`, `tokenAvatar`
 * @param null
...
/**
 * @method getAbi
 * @desc request abi object from the ABOS
...
/**
 * @method getCode
 * @desc request contract code from the ABOS
 * @param {string} - contract address
 * @param {string} - block number
 ...
 * @desc request current block number of ABOS
 * @param null
 ...
 * @desc send transaction to ABOS, if transaction including `privateKey`, or wallet has been set, it will sign the transaction locally, otherwise the transaction will be send to node and signed remote.
 ...
 * @desc send signed transaction to ABOS
...
/**
 * @method storeAbi
 * @desc send contract abi to ABOS
